export const emailData = [
    {   
        ...
        status: "scheduled",
        kind: 'HOST',
        creator: { name: "MiroslavYosifov" },
        participants: [ { name: "MiroslavYosifov" }, { name: "IvanIvanov" } ],
        ...
        history: [
            {
                ...
                date: '06/02/2021',
                content: `Where does it come from?
                Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, makin`,
            },
            {
                creator: { name: "MiroslavYosifov" },
                participants: [ { name: "MiroslavYosifov" }, { name: "IvanIvanov" } ],
